              ...
              {user ? (
                <div className="relative">
                  ...
                  >
                    ...
                    {!isLanding && (
                      <span className="hidden sm:block text-xs text-stone-700 max-w-20 sm:max-w-24 truncate">
                        ...
                        {isLimitedNavRoute ? (
                          <div className="border-t border-stone-100 mt-1">
                            <button
                              ...
                              className="w-full text-left text-xs text-stone-700 hover:bg-stone-50 px-4 py-2.5 transition-colors min-h-9"
                            >
                              View Profile
                            </button>
                            <button
                              ...
                              className="w-full text-left text-xs text-stone-500 hover:bg-stone-50 px-4 py-2.5 transition-colors min-h-9"
                            >
                              Sign Out
                            </button>
                          </div>
                          ...
                          <>
                            {isLanding && (
                              <button
                                ...
                                className="w-full text-left text-xs text-stone-700 font-medium hover:bg-stone-50 px-4 py-2.5 transition-colors min-h-9"
                              >
                                Go to Shop →
                              </button>
                            )}
                ...
                <div className="flex items-center gap-1.5 sm:gap-2 ml-0.5 sm:ml-1">
                  ...
                  <button
                    onClick={() => navigate(user ? "/home" : "/auth")}
                    className={`text-xs sm:text-sm px-4 sm:px-5 py-2 rounded-full transition-colors min-h-9 ${isLanding && !navOpaque ? "bg-white text-stone-900 hover:bg-stone-100" : "bg-stone-900 text-white hover:bg-stone-700"}`}
                  >
