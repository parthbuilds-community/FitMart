...
export default function PaymentPage() {
  ...
  const handleDemoSuccess = async () => {
    ...
    try {
      const data = await apiFetch("/api/payment/demo-success", {
        method: "POST",
        credentials: "include",
        body: { userId: user.uid },
        errorMessage: "Demo order failed",
      });
  ...
  const handlePay = async () => {
    ...
    try {
      const orderResult = await apiFetch("/api/payment/create-order", {
        method: "POST",
        auth: true,
        credentials: "include",
      ...
      if (!orderResult.ok) {
        const e = orderResult.data && typeof orderResult.data === "object" ? orderResult.data : {};
      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            const verifyResult = await apiFetch("/api/payment/verify-payment", {
              method: "POST",
              auth: true,
              credentials: "include",
