        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-10 py-16 sm:py-20 md:py-24">
          <div className="fade-up">
            ...
            <p className="text-base sm:text-lg text-stone-600 leading-relaxed max-w-2xl">
              Please review these terms carefully. By accessing FitMart, you
              agree to be bound by these conditions and our policies.
            </p>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-5 lg:px-10 py-12 sm:py-16 md:py-20">
        ...
        <div className="mb-12 sm:mb-16 fade-up delay-2">
          <div className="bg-white border border-stone-200 rounded-xl p-6 sm:p-8">
            <p className="text-xs tracking-widest uppercase text-stone-400 font-semibold mb-4">
              Quick Links
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
          ...
          <section id="section-1" className="fade-up delay-3">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                By using FitMart, you agree to these Terms. We reserve the right
                to update them anytime.
              </p>
            </div>
          </section>
          ...
          <section id="section-2" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                You're responsible for your account security and all activity on
                it. Notify us of unauthorized use immediately.
              </p>
            </div>
          </section>
          ...
          <section id="section-3" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                Prices and availability may change without notice. We reserve
                the right to refuse orders at incorrect prices.
              </p>
            </div>
          </section>
          ...
          <section id="section-4" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                Place an order as an offer to purchase. All payments are
                processed securely through third-party processors.
              </p>
            </div>
          </section>
          ...
          <section id="section-5" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                Delivery times are estimates. Risk transfers upon delivery to
          ...
          <section id="section-6" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                Accept returns within 30 days of delivery for unworn merchandise
                with original tags.
              </p>
            </div>
          </section>
          ...
          <section id="section-7" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                All content is FitMart property. Reproduction or commercial use
          ...
          <section id="section-8" className="fade-up">
            <div className="border-l-4 border-stone-900 pl-5 h-full">
              ...
              <p className="text-xs sm:text-sm text-stone-600 leading-relaxed">
                FitMart is not liable for indirect, consequential, or punitive
                damages from using our Platform.
              </p>
            </div>
          </section>
        ...
        <div className="mt-16 sm:mt-20 pt-8 sm:pt-12 border-t border-stone-200 fade-up">
          <div className="bg-stone-100 rounded-xl p-6 sm:p-8 text-center">
            <p className="text-sm text-stone-700 leading-relaxed max-w-2xl mx-auto">
              By using FitMart, you acknowledge that you have read, understood,
              and agree to be bound by these Terms & Conditions. If you disagree
