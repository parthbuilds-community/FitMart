...
const Stars = ({ rating = 0, size = "sm" }) => {
  ...
  const starPath =
    "M12 .587l3.668 7.431L24 9.748l-6 5.847L19.335 24 12 19.897 4.665 24 6 15.595 0 9.748l8.332-1.73L12 .587z";
  const sizeClass = size === "lg" ? "w-4 h-4" : "w-3 h-3";

  return (
    <span
      className={`inline-flex items-center gap-0.5 ${size === "lg" ? "text-base" : "text-xs"}`}
      aria-hidden
    >
            ...
            return (
              ...
              >
                ...
                <path
                  ...
                  style={{ fill: "currentColor", opacity: 0.28 }}
                />
                <path
                  d={starPath}
                  fill="currentColor"
      ...
      {Array.from({ length: empty }).map((_, i) => (
        <svg
          key={`empty-${i}`}
          className={`${sizeClass} text-stone-300`}
          viewBox="0 0 24 24"
          xmlns="http://www.w3.org/2000/svg"
        >
  ...
  return (
    <>
      <Shell cartCount={cartCount} onCartOpen={() => setCartOpen(true)}>
        ...
        {/* ── Breadcrumb ── */}
        <div
          className={`pd-fade ${visible ? "in" : ""} border-b border-stone-100 bg-white`}
        >
          <div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-10 py-8 sm:py-12 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 xl:gap-20">
            ...
            <div className={`pd-fade pd-d1 ${visible ? "in" : ""}`}>
              <div
                className="relative bg-stone-100 rounded-2xl overflow-hidden aspect-square
              ...
              >
                ...
                <div className="absolute top-3 sm:top-4 left-3 sm:left-4 flex flex-col gap-2">
                  {product.badge && (
                    <span
                      className="text-[10px] tracking-widest uppercase bg-stone-900 text-white
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 mt-3 sm:mt-4">
                {features.map((f, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-2 sm:gap-2.5 bg-stone-50
            ...
            <div className="flex flex-col" ref={stickyRef}>
              {/* Brand + category */}
              <div
                className={`pd-fade pd-d1 ${visible ? "in" : ""} flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4`}
              >
                <span
                  className="text-[10px] tracking-[0.2em] uppercase text-stone-400 border
              ...
              {/* Price card */}
              <div
                className={`pd-fade pd-d3 ${visible ? "in" : ""}
                ...
                <div className="flex items-end gap-3 mb-1 flex-wrap">
                  ...
                  {product.originalPrice &&
                    product.originalPrice > product.price && (
                      <span
                        className="text-base sm:text-lg text-stone-400 line-through
                                     leading-none mb-0.5"
                      >
              ...
              <div
                className={`pd-fade pd-d5 ${visible ? "in" : ""}
              ...
              <div
                className={`pd-fade pd-d6 ${visible ? "in" : ""}
        ...
        <div className="border-t border-stone-200 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-10">
            ...
            <div
              className="flex gap-4 sm:gap-8 border-b border-stone-100 overflow-x-auto
              ...
              {activeTab === "details" && (
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-stone-600 leading-relaxed">
                    ...
                    {product.category?.toLowerCase()} product trusted by fitness
                    enthusiasts across Mumbai.
                    {product.badge
                      ? ` Rated as "${product.badge}" by our community.`
                      : ""}{" "}
                    Sourced directly from the manufacturer and verified for
                    authenticity.
                  </p>
                  <div className="grid grid-cols-2 gap-3 sm:gap-4 pt-4">
                    {[
                      ...
                      {
                        label: "Reviews",
                        value: product.reviews?.toLocaleString("en-IN"),
                      },
                    ].map(({ label, value }) => (
                      <div
                        key={label}
                        className="bg-stone-50 rounded-xl px-3 sm:px-4 py-3"
                      >
              ...
              {activeTab === "specs" && (
                <div>
                  ...
                  {[
                    ...
                    {
                      label: "MRP",
                      value: fmt(product.originalPrice || product.price),
                    },
                    ...
                    >
                      ...
                      <span className="text-sm text-stone-900 font-medium text-right">
                        {value}
                      </span>
                    </div>
                  ))}
                  ...
                  {[
                    {
                      icon: "⚡",
                      title: "Fast Delivery",
                      body: "Orders dispatched within 24 hours. Delivery within 2–5 business days across MMR.",
                    },
                    {
                      icon: "✓",
                      title: "Free Shipping",
                      body: "Free shipping on all orders above ₹499. Standard charges of ₹49 apply below that threshold.",
                    },
                    {
                      icon: "◎",
                      title: "Easy Returns",
                      body: `${product.category === "Wearables" ? "15" : "30"}-day hassle-free returns. Item must be unused and in original packaging.`,
                    },
                  ].map(({ icon, title, body }) => (
                    <div
                      key={title}
                      className="flex gap-3 sm:gap-4 p-4 sm:p-5 bg-stone-50
                                                rounded-2xl border border-stone-200"
                    >
                      <span className="text-stone-500 text-lg shrink-0 mt-0.5">
                        {icon}
                      </span>
                      <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
                {related.map((rel) => {
                  const rd = rel.originalPrice
                    ? Math.round(
                        ((rel.originalPrice - rel.price) / rel.originalPrice) *
                          100,
                      )
                    : null;
                  return (
                    ...
                    >
                      <div className="relative bg-stone-100 aspect-square overflow-hidden">
                        ...
                        {rel.badge && (
                          <span
                            className="absolute top-2 left-2 text-[9px] tracking-widest uppercase
                        ...
                        {rd && (
                          <span
                            className="absolute top-2 right-2 text-[9px] bg-white text-stone-600
                      ...
                      <div className="p-3 sm:p-4">
                        ...
                        <p
                          className="text-sm text-stone-900 font-medium leading-snug
                                      line-clamp-2 mb-2"
                        >
                          {rel.name}
                        </p>
