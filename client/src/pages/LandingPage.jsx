...
const formatStat = (n, loading) =>
  loading ? "—" : Number(n || 0).toLocaleString("en-IN");
...
const GITHUB_REPO =
  "https://github.com/parthbuilds-community/FitMart";

const INSTAGRAM =
  "https://instagram.com/parth.builds";
...
export default function LandingPage() {
  ...
  const STATS = [
    {
      value: formatStat(ghStats?.stars, ghLoading),
      label: "GitHub Stars",
    },
    {
      value: formatStat(ghStats?.forks, ghLoading),
      label: "Forks",
    },
    {
    ...
    {
      value: formatStat(ghStats?.commits, ghLoading),
      label: "Commits",
    },
  ];
  ...
  // Scroll listener + initial animation
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-white font-['DM_Sans',sans-serif] overflow-x-hidden">
      <style>{`
        ...
        .testimonial-enter {
          animation: tFadeIn 0.6s ease forwards;
        }
          ...
          <div className="max-w-4xl">
            ...
            <h1
              className="
                ...
                text-[2.4rem] sm:text-6xl md:text-7xl lg:text-8xl
                text-stone-900 leading-[1.05]
                mb-5 sm:mb-6 tracking-tight
              "
            >
              ...
              <div className="hero-line">
                ...
                >
                  Nothing{" "}
                  <em className="not-italic text-stone-400">
                    extra.
                  </em>
                </span>
              </div>
            ...
            <p
              className={`
                fade-up ${visible ? "visible" : ""} delay-3
                text-base sm:text-lg text-stone-500
                max-w-xl leading-relaxed
                mb-8 sm:mb-10
              `}
            >
              Curated equipment, verified nutrition, and
              digital coaching — built for people who take
            ...
            <div
              className={`
                fade-up ${visible ? "visible" : ""} delay-4
              ...
              >
                ...
                <span
                  className="
                    ...
                    font-medium min-w-7 text-center
                  "
                >
                  {formatStat(
                    ghStats?.stars,
        ...
        <div className="border-t border-stone-200 bg-white">
          ...
          >
            {STATS.map((stat, index) => (
              <div
                key={index}
                className="stat-card text-center md:text-left"
              >
                <div
                  className="
                    font-['DM_Serif_Display']
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
            {CATEGORIES.map((category, index) => (
              <div
                key={index}
                className={`
                  cat-card rounded-2xl p-6 sm:p-8 md:p-10
                  flex flex-col justify-between
                  min-h-56 sm:min-h-64 md:min-h-72
                  cursor-pointer ${category.bg}
                `}
                onClick={() =>
                  navigate("/home", {
                    state: {
              ...
              >
                ...
                <button
                  className={`
                    mt-6 sm:mt-8 self-start
                    text-xs border px-5 py-2.5
                    rounded-full transition-colors
                    ${category.btn}
                    min-h-10 active:scale-[0.97]
                  `}
                  onClick={(event) => {
            ...
            <div className="text-center py-12 text-stone-400">
              <div
                className="
                  ...
                  h-8 w-8 border-4
                  border-stone-300 border-t-stone-900
                  mb-4
                "
              />
              ...
              {products.slice(0, 4).map((product) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="
                        relative bg-stone-100 aspect-square
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {PROGRAMS.map((program, index) => (
              ...
              >
                ...
                <button
                  className="
                    text-xs border border-stone-300
                    text-stone-700 px-5 py-2.5
                    rounded-full
                    hover:bg-stone-900
                    hover:text-white
            ...
            {[
              {
                ...
                desc:
                  "Every supplement sourced direct from manufacturer with QR batch verification.",
              },
              {
                icon: "⚡︎",
                title: "Mumbai-Speed Delivery",
                desc:
                  "24-hour fulfillment within MMR. Real-time tracking via WhatsApp and email.",
              },
              {
                icon: "◎",
                title: "Fitness-as-a-Service",
                desc:
                  "Buy a product, unlock a plan. Equipment and coaching aren't separate here.",
              },
            ].map((feature, index) => (
              <div
                key={index}
              ...
              >
                ...
                <h3 className="font-['DM_Serif_Display'] text-xl">
                  {feature.title}
                </h3>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p
              className="
                text-base sm:text-lg text-stone-600
                leading-relaxed
                mb-8 sm:mb-12
              "
            >
              We started FitMart because we believe
              fitness shouldn't be complicated. By bringing
              together equipment, nutrition, and coaching
              under one roof, we've created Mumbai's first
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <button
              ...
              className="
                bg-white text-stone-900 text-sm
            ...
            <a
              ...
              className="
                ...
                text-sm px-8 py-4 rounded-full
            ...
            className={`
              ...
              ${
                isOpaque
                  ...
                  : "border-stone-300 text-stone-700 hover:bg-white/10"
              }
            `}
          >
            <GithubIcon className="w-3.5 h-3.5" />
        ...
        >
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p
              ...
              "
            >
              Mumbai's open-source fitness marketplace —
              built in public, powered by community.
            </p>
      ...
      <div className="border-t border-stone-900">
        ...
        >
          <p
            ...
            "
          >
            © {year} FitMart · Built by Parth Builds
            Community
          </p>
