...
const CustomTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div className="bg-white border border-stone-200 rounded-xl px-4 py-3 text-sm shadow-lg">
      <p className="text-xs text-stone-400 uppercase tracking-[0.12em] mb-1">
        {label}
      </p>
      {payload.map((p) => (
...
const SectionCard = ({ title, eyebrow, children }) => (
  ...
  >
    ...
    <h2
      style={{ fontFamily: "'DM Serif Display', serif" }}
      className="text-xl text-stone-900 mb-5 sm:mb-6"
    >
      {title}
    </h2>
    {children}
            ...
            {[
                ...
                icon: (
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={1.5}
                      d="M12 2v2M6.2 4.2l1.4 1.4M2 12h2M4.2 17.8l1.4-1.4M12 20v2M17.8 19.8l-1.4-1.4M20 12h2M19.8 6.2l-1.4 1.4M7 11a5 5 0 1010 0 5 5 0 00-10 0z"
                    />
                  </svg>
                ),
              },
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div
                    className="w-11 h-11 sm:w-12 sm:h-12 rounded-xl bg-stone-100 flex items-center justify-center
                ...
                <h3
                  style={{ fontFamily: "'DM Serif Display', serif" }}
                  className="text-xl text-stone-900 mb-2 select-none sm:select-auto"
                >
                  {card.title}
                </h3>
                <p className="text-sm text-stone-500 leading-relaxed mb-4 select-none sm:select-auto">
                  {card.desc}
                </p>
