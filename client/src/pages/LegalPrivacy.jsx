        ...
        <div className="max-w-5xl mx-auto px-5 lg:px-10 py-16 sm:py-20 md:py-24">
          <div className="fade-up">
            ...
            <p className="text-base sm:text-lg text-stone-600 leading-relaxed max-w-2xl">
              We take your privacy seriously. This policy explains how FitMart
      ...
      <main className="max-w-4xl mx-auto px-5 lg:px-10 py-12 sm:py-16 md:py-20">
        ...
        <div className="mb-12 sm:mb-16 fade-up delay-2">
          <div className="bg-white border border-stone-200 rounded-xl p-6 sm:p-8">
            <p className="text-xs tracking-[0.1em] uppercase text-stone-400 font-semibold mb-4">
              Quick Links
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <a
                  key={idx}
                  href={`#section-${idx + 1}`}
                  className="text-sm text-stone-600 hover:text-stone-900 transition-colors flex items-center gap-2"
                >
        ...
        <div className="space-y-10 sm:space-y-14">
          ...
          <section id="section-1" className="fade-up delay-3 scroll-mt-20">
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <p className="text-sm sm:text-base text-stone-600 leading-relaxed mb-5">
                FitMart collects information to provide better services to our
                customers through various methods:
              </p>

              <div className="space-y-6">
                <div className="bg-stone-50 rounded-lg p-4 sm:p-5">
                  <h3 className="font-semibold text-stone-800 mb-3 text-sm sm:text-base">
            ...
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 sm:p-5 mb-5">
                <p className="text-sm text-stone-700 leading-relaxed">
                  ...
                  our services while maintaining your trust and security.
                </p>
              </div>
              <ul className="space-y-3 text-sm sm:text-base text-stone-600">
                <li className="flex gap-3">
                  <span className="text-stone-400 flex-shrink-0 font-bold">
                    ✓
                  </span>
                  <span>
          ...
          <section id="section-3" className="fade-up scroll-mt-20">
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <p className="text-sm sm:text-base text-stone-600 leading-relaxed mb-5">
                FitMart does not sell your personal information. We may share
              ...
              <div className="space-y-3">
                <div className="border border-stone-200 rounded-lg p-4 sm:p-5">
                  ...
                  <p className="text-sm text-stone-600">
                    Shipping carriers, payment processors, and analytics
                    partners who help us operate our platform
                  </p>
                </div>
                <div className="border border-stone-200 rounded-lg p-4 sm:p-5">
                  <p className="font-semibold text-stone-800 text-sm mb-2">
          ...
          <section id="section-4" className="fade-up scroll-mt-20">
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <p className="text-sm sm:text-base text-stone-600 leading-relaxed mb-5">
                FitMart implements reasonable administrative, technical, and
                physical safeguards to protect your personal information against
              ...
              <div className="bg-amber-50 border-l-4 border-amber-400 rounded p-4 sm:p-5">
                ...
                <p className="text-sm text-stone-600 leading-relaxed">
                  ...
                  regularly review and update our security practices to maintain
            ...
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="border border-stone-200 rounded-lg p-4 flex items-start gap-3">
                  <span className="text-stone-900 font-bold text-lg flex-shrink-0">
                    ✓
                  </span>
          ...
          <section id="section-6" className="fade-up scroll-mt-20">
            <div className="border-l-4 border-stone-900 pl-6 sm:pl-8">
              ...
              <div className="bg-white border border-stone-200 rounded-lg p-6 space-y-4">
                <div>
                  <p className="text-xs text-stone-400 uppercase tracking-wider font-semibold mb-2">
                    Email
                  </p>
        ...
        <div className="mt-16 sm:mt-20 pt-8 sm:pt-12 border-t border-stone-200 fade-up">
          <div className="bg-stone-100 rounded-xl p-6 sm:p-8 text-center">
            <p className="text-sm text-stone-700 leading-relaxed max-w-2xl mx-auto">
              Your privacy is important to us. FitMart is committed to
              protecting and respecting your personal information while
              providing you with an excellent service experience.
            </p>
          </div>
        </div>
      </main>
