            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
              <div>
                ...
                <p className="text-sm text-stone-300 max-w-lg leading-relaxed">
                  Progressive overload training, protein-optimized nutrition,
                  and expert programming to build lean mass and strength.
                </p>
              </div>
              <button
              ...
              {[
                {
                  ...
                  desc: "Systematically increasing training stimulus to drive continuous muscle adaptation and growth.",
                },
                {
                  icon: "⚡",
                  title: "Protein Synthesis",
                  desc: "Optimized protein timing and distribution to maximize muscle protein synthesis throughout the day.",
                },
                {
                  icon: "✓",
                  title: "Recovery Protocols",
                  desc: "Structured rest days and deload weeks ensure your body rebuilds stronger between sessions.",
                },
              ].map((tip, i) => (
