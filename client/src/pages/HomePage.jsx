  ...
  return (
    ...
    >
      {Array.from({ length: full }).map((_, i) => (
        <svg
          key={`full-${i}`}
          className={`${sizeClass} text-stone-500`}
          viewBox="0 0 24 24"
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 font-['DM_Sans',sans-serif]">
      ...
      {/* Search bar */}
      <div
        className={`search-expand ${searchOpen ? "open" : ""} border-t border-stone-100`}
      >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-5 lg:px-10 py-8 sm:py-10 space-y-12 sm:space-y-16">
        ...
        <section
          id="tracking"
          className="py-12 sm:py-16 border-y border-stone-100"
        >
          ...
          >
            <div>
              ...
              <p className="text-sm text-stone-500 max-w-md leading-relaxed">
                Points for every purchase and every fitness milestone. Redeem
                against equipment, supplements, or coaching.
              </p>
            </div>
            <button
